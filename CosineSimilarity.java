...
public class CosineSimilarity {
    ...
    public static double GetSimilarity(String vector1, String vector2) {
        String doc1 = vector1.toLowerCase();
        String doc2 = vector2.toLowerCase();
...
public static void main(String args[])
{
           ...
           CosineSimilarity.GetSimilarity("https://en.oxforddictionaries.com/definition/crawler", "https://en.oxforddictionaries.com/grammar/");
